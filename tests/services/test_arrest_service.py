...
class TestArrestService(TestCase):
    ...
    def test_find_cases(self):
        ...
        reader = self.read_pdf(ref)
        arrest = ArrestModelDao(ref=ref, is_rectified = False)
        cases : List[CaseModelDao] = self.arrest_service.find_cases(ref, reader, arrest)
    ...
    def test_find_keywords(self):
        ...
        keywords : List[KeywordModelDao] = self.arrest_service.find_keywords(title, ["test", keyword_1], ref, reader, arrest)
