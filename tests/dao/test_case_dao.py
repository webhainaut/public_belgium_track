from main.Models.Models import CaseModel, ArrestModel
...
class TestCaseDao(TestAbstractDao):
    ...
    def test_get(self):
        case: CaseModel = self.caseDao.get(self.numRole1)
    ...
    def test_add_arrest_with_case(self):
        ...
        new_arrest = ArrestModel(ref=self.ref, language="fr", chamber="VI", cases=[merged_case])
        ...
        case2: CaseModel = self.caseDao.get(self.numRole1)
