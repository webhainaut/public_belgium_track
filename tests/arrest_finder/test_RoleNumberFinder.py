...
class TestRoleNumberFinder(TestAbstractFinder):

    def setUp(self):
        self.roleNumberFinder = RoleNumberFinder("finder")
    ...
    def test_find_role_several(self):
        ...
        self.assertEqual(
            ["236.088", "236.089", "236.090", "236.091", "236.092", "236.093", "236.094",
             ...
             "236.145", "236.146", "236.147", "236.148", "236.151", "236.156"], roles_number,
            "Only one")
